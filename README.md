...
[![Tests](https://img.shields.io/badge/Tests-62%2F62%20Passing-729B1B?style=for-the-badge&logo=vitest&logoColor=white)](https://vitest.dev)
...
```mermaid
flowchart TD
    subgraph ClientLayer ["Decibel Client (React 19 + Canvas Wavefield)"]
        UI["Sound-Reactive Arcade UI"]
        FloatingDock["Interactive Floating Dock"]
        AudioEngine["HTML5 Persistent Streamer"]
    ...
    subgraph ServerLayer ["Server Cluster (Node.js Stateful Gateway)"]
        ...
        Sanitizer["Profanity & Remix Sanitizer"]
    ...
    subgraph ExternalServices ["External Engines"]
        ...
        SpotifyParser["Spotify Playlist Resolver"]
